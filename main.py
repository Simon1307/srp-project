...
def main():
    ...
    monet_filepath = 'gan-getting-started/monet_tfrec/*.tfrec'
    photo_filepath = 'gan-getting-started/photo_tfrec/*.tfrec'
    ...
    monet_discriminator_optimizer2 = tf.keras.optimizers.Adam(
        learning_rate=lr_schedule,
        beta_1=beta_1
    )
    ...
    monet_discriminator_optimizer_guess = tf.keras.optimizers.Adam(
        learning_rate=lr_schedule,
        beta_1=beta_1
    )
    photo_discriminator_optimizer_guess = tf.keras.optimizers.Adam(
        learning_rate=lr_schedule,
        beta_1=beta_1
    )
